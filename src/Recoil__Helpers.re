[@bs.module "recoil"]
external waitForAll:
  array(Recoil__Value.t('value, 'mode)) =>
  Recoil__Value.readOnly(array('value)) =
  "waitForAll";

[@bs.module "recoil"]
external waitForAll2:
  ((Recoil__Value.t('v1, 'm1), Recoil__Value.t('v2, 'm2))) =>
  Recoil__Value.readOnly(('v1, 'v2)) =
  "waitForAll";
...
external waitForAll3:
  ...
  Recoil__Value.readOnly(('v1, 'v2, 'v3)) =
  "waitForAll";
...
external waitForAll4:
  ...
  Recoil__Value.readOnly(('v1, 'v2, 'v3, 'v4)) =
  "waitForAll";
...
external waitForAll5:
  ...
  Recoil__Value.readOnly(('v1, 'v2, 'v3, 'v4, 'v5)) =
  "waitForAll";
...
external waitForAll6:
  ...
  Recoil__Value.readOnly(('v1, 'v2, 'v3, 'v4, 'v5, 'v6)) =
  "waitForAll";

[@bs.module "recoil"]
external waitForAny:
  array(Recoil__Value.t('value, 'mode)) =>
  Recoil__Value.readOnly(array(Recoil__Loadable.t('value))) =
  "waitForAny";
...
external waitForAny2:
  ...
  Recoil__Value.readOnly(
    (Recoil__Loadable.t('v1), Recoil__Loadable.t('v2)),
  ) =
  "waitForAny";
...
[@bs.module "recoil"]
external noWait:
  Recoil__Value.t('value, 'mode) =>
  Recoil__Value.readOnly(Recoil__Loadable.t('value)) =
  "noWait";
